...
public class UpdateDeleteAgent extends javax.swing.JFrame {
    ...
    /**
     * Creates new form UpdateDeleteAgent
     */
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Update & Delete Employees");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            Connection con=ConnectionProvider.getCon();
            PreparedStatement ps=con.prepareStatement("update employee set name=?, mobileNo=?, address=?, email=?, designation=? where empID=?");
            ps.setString(1, name);
